<template>
  ...
  >
    ...
    <div class="lg:w-1/2 text-center lg:text-left z-10">
      ...
      <h1 class="text-5xl font-medium text-dark mt-2">
        IT Consultant & <br />
        Outsourcing
      </h1>
      <p class="text-neutral mt-4">
        We believe that technology is for every business. <br />
        From roadside stall businesses to publicly listed companies.
    ...
    <!-- Right Image Grid -->
    <div class="lg:w-1/2 grid grid-cols-2 gap-2 lg:gap-4 mt-8 lg:mt-0">
      <img
        src="/src/assets/home/hero-1.png"
        alt="Teamwork"
        class="w-full h-32 lg:h-40 xl:h-52 object-cover object-center"
      />
      <img
        src="/src/assets/home/hero-2.png"
        alt="Analytics"
        class="w-full h-32 lg:h-40 xl:h-52 object-cover object-center"
      />
      <img
        src="/src/assets/home/hero-3.png"
        alt="Coding"
        class="w-full h-32 lg:h-40 xl:h-52 object-cover object-center"
      />
      <img
        src="/src/assets/home/hero-4.png"
        alt="Meeting"
        class="w-full h-32 lg:h-40 xl:h-52 object-cover object-center"
      />
    </div>
